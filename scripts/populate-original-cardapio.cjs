...
const cardapioData = [
  ...
  // DOCES (5 itens)
  { nome: 'Chocolate com Morango', descricao: 'Chocolate com morango.', categoria: 'Doces', precos: { P: 30, M: 35, G: 40, GG: 54 } },
  { nome: 'Banana Nevada', descricao: 'Banana com canela, creme de leite e chocolate branco com borda de doce de leite.', categoria: 'Doces', precos: { P: 30, M: 35, G: 40, GG: 54 } },
  { nome: 'Cartola', descricao: 'Mussarela, catupiry, banana fatiada, açúcar e canela com borda de doce de leite.', categoria: 'Doces', precos: { P: 30, M: 35, G: 40, GG: 54 } },
  { nome: 'Romeu e Julieta', descricao: 'Mussarela coberta com fatia de goiabada, com borda de doce de leite.', categoria: 'Doces', precos: { P: 30, M: 35, G: 40, GG: 54 } },
  { nome: 'Dois Amores', descricao: 'Chocolate branco e chocolate de avelã com borda de doce de leite.', categoria: 'Doces', precos: { P: 30, M: 35, G: 40, GG: 54 } },
